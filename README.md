...
|--------|----------|------------|-------------|
| 💳 **[Bank Card Management System](https://github.com/Infern74/bank-card-management-system)**<br>*(Тестовое задание)* | Backend-система для управления банковскими картами и транзакциями. Реализована полная бизнес-логика работы с финансовыми операциями. | `Java 17` `Spring Boot 3` `PostgreSQL` `Docker` `REST API` `OpenAPI` | Полноценная бизнес-логика, контейнеризация, структурированная обработка ошибок, четкое разделение слоев, документация API через Swagger |
